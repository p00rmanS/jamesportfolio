...
export const ko: Translations = {
  ...
  sections: {
    ...
    faq: {
      label: '자주 묻는 질문',
      title: '예약하기 전에.',
      description: '첫 상담 전에 자주 나오는 질문들입니다.',
    },
    booking: {
      label: '예약',
  ...
  faq: {
    items: [
      {
        question: '일반적인 프로젝트 기간은 얼마나 걸리나요?',
        answer:
          '규모에 따라 다르지만, 대부분의 영상 및 웹 프로젝트는 착수부터 납품까지 1~3주 정도 걸립니다. 자동화 구축은 보통 더 빨라서 일주일 안에 완료되는 경우가 많습니다.',
      },
      {
        question: '비용은 어떻게 산정되나요?',
        answer:
          '상담 통화 후 각 프로젝트에 맞춘 견적을 드리기 때문에 무작정 가격을 매기지 않습니다. 단발성 작업은 보통 고정가, 지속적인 콘텐츠·자동화 시스템은 보통 월 구독 방식입니다.',
      },
      {
        question: '납품 후 수정이 필요하면 어떻게 하나요?',
        answer: '모든 프로젝트에는 최종 납품 전 한 차례의 수정 작업이 포함되어 있습니다. 이후 지원이나 업데이트는 요청 시 진행됩니다.',
      },
      {
        question: '상담 전에 원하는 바를 정확히 알아야 하나요?',
        answer: '아니요. 그것을 함께 정리하는 것이 상담 통화의 목적입니다. 해결하려는 문제만 가지고 오셔도 충분하며, 해결책까지 정해둘 필요는 없습니다.',
      },
      {
        question: '이 서비스들을 조합할 수 있나요?',
        answer:
          '네. 영상, 콘텐츠, 웹, 자동화는 서로 연결되도록 설계되어 있습니다. 많은 고객이 한 가지 서비스로 시작한 뒤, 자리를 잡으면 다른 서비스를 추가합니다.',
      },
    ],
  },
  commandPalette: {
    placeholder: '섹션 및 작업 검색…',
