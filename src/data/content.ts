...
export const content: SiteContent = {
  ...
  projects: [
    ...
    {
      id: 'giovanni-shrimp-truck-redesign',
      title: "Giovanni's Shrimp Truck — Website Redesign",
      client: "Giovanni's Shrimp Truck",
      category: 'Web Experiences',
      year: '2026',
      cover: {
        type: 'image',
        src: '/images/projects/giovanni-shrimp-truck.jpg',
        alt: "Giovanni's Shrimp Truck redesigned homepage hero",
      },
      summary: 'A modern rebuild of a beloved North Shore Oʻahu food truck’s outdated early-2000s website.',
      servicesProvided: ['Web Design', 'Frontend Development', 'Multi-language Support', 'Interaction Design'],
      description:
        "Giovanni's has been serving garlic shrimp on Oʻahu's North Shore since 1993, but their site hadn't been touched since the mid-2000s. This redesign keeps everything that matters — the menu, the truck locations, the history, the press — in a fast, modern, mobile-first build, with live date/weather in the header and a language switcher for the international tourist traffic the trucks actually get.",
      outcome: 'Concept build complete; live domain migration pending client sign-off.',
      isSample: false,
      liveUrl: 'https://giovanni-shrimp-truck.netlify.app',
    },
    {
